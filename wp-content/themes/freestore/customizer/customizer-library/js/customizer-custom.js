    ...
    $( window ).load( function() {
        ...
        function freestore_customizer_slider_check( slider_select_value ) {
            if ( slider_select_value == 'freestore-slider-default' ) {
                $( '#sub-accordion-section-freestore-slider-section #customize-control-freestore-meta-slider-shortcode' ).hide();
                $( '#sub-accordion-section-freestore-slider-section #customize-control-freestore-slider-cats' ).show();
                $( '#sub-accordion-section-freestore-slider-section #customize-control-freestore-slider-size' ).show();
                $( '#sub-accordion-section-freestore-slider-section #customize-control-freestore-slider-linkto-post' ).show();
                $( '#sub-accordion-section-freestore-slider-section #customize-control-freestore-slider-remove-title' ).show();
                $( '#sub-accordion-section-freestore-slider-section #customize-control-freestore-slider-auto-scroll' ).show();
            } else if ( slider_select_value == 'freestore-meta-slider' ) {
                $( '#sub-accordion-section-freestore-slider-section #customize-control-freestore-slider-cats' ).hide();
                $( '#sub-accordion-section-freestore-slider-section #customize-control-freestore-slider-size' ).hide();
                $( '#sub-accordion-section-freestore-slider-section #customize-control-freestore-slider-linkto-post' ).hide();
                $( '#sub-accordion-section-freestore-slider-section #customize-control-freestore-slider-remove-title' ).hide();
                $( '#sub-accordion-section-freestore-slider-section #customize-control-freestore-slider-auto-scroll' ).hide();
                $( '#sub-accordion-section-freestore-slider-section #customize-control-freestore-meta-slider-shortcode' ).show();
            } else {
                $( '#sub-accordion-section-freestore-slider-section #customize-control-freestore-slider-cats' ).hide();
                $( '#sub-accordion-section-freestore-slider-section #customize-control-freestore-slider-size' ).hide();
                $( '#sub-accordion-section-freestore-slider-section #customize-control-freestore-slider-linkto-post' ).hide();
        ...
        function freestore_customizer_page_style_check( body_style_select_value ) {
            if ( body_style_select_value == 'freestore-page-styling-flat' ) {
                $( '#sub-accordion-section-freestore-site-layout-section #customize-control-freestore-page-styling-color' ).hide();
            } else {
                $( '#sub-accordion-section-freestore-site-layout-section #customize-control-freestore-page-styling-color' ).show();
            }
        }
        ...
        function freestore_page_layout_type_check( freestore_page_select_value ) {
            if ( freestore_page_select_value == 'freestore-page-fimage-layout-banner' ) {
                $( '#sub-accordion-section-freestore-site-layout-section #customize-control-freestore-page-fimage-size' ).show();
                $( '#sub-accordion-section-freestore-site-layout-section #customize-control-freestore-page-fimage-fullwidth' ).show();
            } else {
                $( '#sub-accordion-section-freestore-site-layout-section #customize-control-freestore-page-fimage-size' ).hide();
                $( '#sub-accordion-section-freestore-site-layout-section #customize-control-freestore-page-fimage-fullwidth' ).hide();
            }
        }
