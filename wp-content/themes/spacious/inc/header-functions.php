...
function spacious_header_image_markup( $html, $header, $attr ) {
    ...
    background-repeat: no-repeat;box-shadow: 5px 5px 5px rgba(0, 0, 0, 0.8);margin-right: 0px;margin-left: 0px;">							
  							...
  							<div class="col-md-6 r-side">
  								<div class="col-md-6">
									<span class="tell">тел: 8-916-410-03-33</span>
									<span class="tell" >тел: 8-916-410-03-33</span>
									<p class="tell"><span class="mail-sp" >Email: </span> artplitru@gmail.com</p>							
  								</div>
  								<div class="col-md-6" style="padding: 2%;color: #ffffff;line-height: 32px;">
  									Ясенево</br>
  									Клинский район</br>
									Московская область.									
  								</div>								
